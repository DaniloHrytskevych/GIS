...
function generateEnhancedPDFContent(analysisResult, d, scoreColor, categoryColor, shouldBuild) {
  return `
    ...
    <h3>1.1. Загальна модель оцінки</h3>
    
    <div class="formula-box">
      <p style="margin: 0 0 8px 0; font-weight: bold;">Інтегральна формула розрахунку:</p>
      <code style="line-height: 1.8;">
        I = F1 + F2 + F3 + F4 + F5 + F6 - F7
      </code>
      <p style="margin: 8px 0 0 0; font-size: 11px;">
        де: I - інтегральний показник потенціалу (0-100 балів);<br/>
        F1 - попит населення (0-25 балів, 25%);<br/>
        F2 - природно-заповідний фонд (0-20 балів, 20%);<br/>
        F3 - природні ресурси (0-15 балів, 15%);<br/>
        F4 - транспортна доступність (0-15 балів, 15%);<br/>
        F5 - інфраструктура (0-10 балів, 10%);<br/>
        F6 - профілактика пожеж (0-5 балів, 5%);<br/>
        F7 - штраф за насиченість (0-15 балів, -15%).
      </p>
    </div>
    
    <h3>1.2. Наукове обґрунтування методології</h3>
