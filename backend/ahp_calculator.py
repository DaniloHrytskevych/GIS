...
class AHPCalculator:
    ...
    def __init__(self):
        ...
        self.pairwise_matrix = np.array([
            ...
            [1.0, 2.0, 3.0, 3.0, 5.0, 7.0, 5.0],  # Попит
            [0.5, 1.0, 2.0, 2.0, 3.0, 5.0, 3.0],  # ПЗФ
            [0.33, 0.5, 1.0, 1.0, 3.0, 5.0, 3.0], # Природа
            [0.33, 0.5, 1.0, 1.0, 3.0, 5.0, 3.0], # Транспорт
            [0.2, 0.33, 0.33, 0.33, 1.0, 3.0, 2.0], # Інфраструктура
            [0.14, 0.2, 0.2, 0.2, 0.33, 1.0, 0.5], # Пожежі
            [0.2, 0.33, 0.33, 0.33, 0.5, 2.0, 1.0]  # Насиченість (негативний)
        ])
