...
class AHPCalculator:
    ...
    def __init__(self):
        ...
        # Скориговано для отримання ваг: ~25%, 20%, 15%, 15%, 10%, 5%, 15% (штраф)
        self.pairwise_matrix = np.array([
            # Поп     ПЗФ     Прир    Тран    Інфр    Пож     Нас
            [1.0,     1.5,    2.0,    2.0,    3.0,    6.0,    2.0],    # Попит (25%)
            [1/1.5,   1.0,    1.5,    1.5,    2.5,    5.0,    1.5],    # ПЗФ (20%)
            [1/2.0,   1/1.5,  1.0,    1.0,    2.0,    4.0,    1.0],    # Природа (15%)
            [1/2.0,   1/1.5,  1.0,    1.0,    2.0,    4.0,    1.0],    # Транспорт (15%)
            [1/3.0,   1/2.5,  1/2.0,  1/2.0,  1.0,    3.0,    0.67],   # Інфраструктура (10%)
            [1/6.0,   1/5.0,  1/4.0,  1/4.0,  1/3.0,  1.0,    0.33],   # Пожежі (5%)
            [1/2.0,   1/1.5,  1.0,    1.0,    1/0.67, 1/0.33, 1.0]     # Насиченість (15% штраф)
        ])
