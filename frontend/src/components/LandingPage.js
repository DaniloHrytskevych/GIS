...
import { MdLandscape, MdAnalytics, MdDownload, MdNaturePeople, MdTerrain, MdDirectionsCar, MdLocalHospital, MdLocalGasStation, MdWifi, MdApartment, MdElectricalServices, MdPark, MdEmojiEvents, MdPeople } from 'react-icons/md';
